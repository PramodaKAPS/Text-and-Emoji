...
def setup_model_and_optimizer(model_name, num_labels, tf_train_dataset, epochs=6, lr=5e-6, cache_dir=None):
...
def compile_and_train(model, optimizer, tf_train_dataset, tf_val_dataset, epochs=6):
